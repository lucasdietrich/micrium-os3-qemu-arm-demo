...
# https://github.com/zephyrproject-rtos/net-tools/blob/master/net-setup.sh
...
If no parameters are given, then "meth" network interface and "meth.conf"
...
$ net-setup.sh
$ net-setup.sh --config meth-vlan.conf
